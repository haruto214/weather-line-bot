...
前提：作成者はPython初学者であり、アプリ開発経験なし（新卒1年目）  
開発の背景：Pythonでアプリ開発したい（題材は日常であったら便利なもの）  
...
4. LINE Messaging API の Push であらかじめ指定したLINEグループに送信  
  ※ LINEで友だち追加されたユーザー全員にメッセージが配信されることはありません。
5. GitHub Actions の schedule で毎日6:30自動実行（cron は UTC 指定）
